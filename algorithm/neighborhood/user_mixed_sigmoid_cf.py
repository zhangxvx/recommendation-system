...
class UserMixedSigmoidCF(UserMixedCosCF):
    ...
    def _train(self):
        ...
        self.act_sim, self.boo = self.compute_sigmoid_similarity(user_num, item_num, self.train_dataset.get_items())
